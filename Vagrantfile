...
Vagrant.configure(2) do |config|
  ...
  # Default to `./html` if not otherwise specified.
  ENV['SYNCED_FOLDER'] = ENV['SYNCED_FOLDER'] ? ENV['SYNCED_FOLDER'] : './html'
  config.vm.synced_folder ENV['SYNCED_FOLDER'], "/vagrant_data",
    id:            "vagrant-root",
    owner:         "vagrant",
    group:         "www-data",
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    sudo ln -fs /vagrant_data /var/www/html
